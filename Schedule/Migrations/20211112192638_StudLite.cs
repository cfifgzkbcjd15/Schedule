...
{
    public partial class StudLite : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Schedulee", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Schedulee_EducationalInstitutions_EducationalInstitutionsId",
                        column: x => x.EducationalInstitutionsId,
                        principalTable: "EducationalInstitutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulee_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulee_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulee_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulee_Specializations_SpecializationId",
                        column: x => x.SpecializationId,
                        principalTable: "Specializations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulee_Teachers_TeachersId",
                        column: x => x.TeachersId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Schedulee_Times_TimeId",
                        column: x => x.TimeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedulee_EducationalInstitutionsId",
                table: "Schedulee",
                column: "EducationalInstitutionsId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedulee_GroupId",
                table: "Schedulee",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedulee_LectureId",
                table: "Schedulee",
                column: "LectureId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedulee_LevelId",
                table: "Schedulee",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedulee_SpecializationId",
                table: "Schedulee",
                column: "SpecializationId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedulee_TeachersId",
                table: "Schedulee",
                column: "TeachersId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedulee_TimeId",
                table: "Schedulee",
                column: "TimeId");
        }
